...
public class PageRankDriver{
    ...
    public static void main(String[] args) throws Exception {
        ...
        FileInputFormat.addInputPath(prmatrixjob, new Path("output_"));
        ...
        while(i<10)
        {
            ...
            for (FileStatus status : fileStatus) {
                //Adding the file to cache from second iteration onwards.
                prjob.addCacheFile(status.getPath().toUri());
            }
